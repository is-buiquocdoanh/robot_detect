...
bool yolov8_msgs__msg__human_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._human_position.HumanPosition", full_classname_dest, 45) == 0);
  }
  yolov8_msgs__msg__HumanPosition * ros_message = _ros_message;
  {  // x_center
...
{
  /* NOTE(esteve): Call constructor of HumanPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._human_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HumanPosition");
